...
- **Günün kelimesi** — A1–C1 seviyelerinde ~1450 kelime, Türkçe anlam; tanım, telaffuz ve örnek cümle dictionaryapi.dev'den.
...
| `api.dictionaryapi.dev` | Kelime tanımı ve telaffuzu |
