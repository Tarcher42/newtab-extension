...
- [x] Çeviride dil kodu desteği (`tr es merhaba`, `tr en-de hello`) ve MyMemory yanıtlarında çöp kayıtları eleyen puanlama; yerel listede olan kelimeler için çevrimiçi istek atılmıyor
